...
export default async function Home() {
  ...
  // 1. Pedimos el usuario y los labs
  const {
    data: { user },
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-green-500/30">
        ...
        <div className="flex gap-4 items-center">
          {!user ? (
            ...
            <>
              ...
              {/* Botón de cerrar sesión para probar el candado */}
              <button
                onClick={async () => {
                  "use client"; // Esto es solo un recordatorio, si falla, lo pondremos en un componente aparte
      ...
      {/* Hero Section (Tu portada que se queda fija) */}
      ...
      <main className="max-w-7xl mx-auto px-6 pb-24">
        {user ? (
              ...
              >
                ...
                <div className="relative bg-[#0A0A0A] border border-white/10 p-8 rounded-2xl h-full flex flex-col justify-between hover:border-white/20 transition">
                  ...
                  <div className="mt-8 pt-6 border-t border-white/5 flex justify-between items-center text-sm font-bold">
                    <span className="text-gray-600">5 MÓDULOS</span>
          ...
          /* Lo que ve el que no ha entrado */
